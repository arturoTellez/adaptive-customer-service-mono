    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const newTicket = await api.createTicket({
                user_id: user.id, // AQUÍ ESTABA EL ERROR - usar user.id del contexto
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div className="flex gap-4 pt-6">
                            <button
                                ...
                                className="flex-1 bg-kavak-gray-100 hover:bg-kavak-gray-200 text-kavak-navy font-semibold py-4 px-6 rounded-xl transition-all disabled:opacity-50"
                            >
                                Cancelar
                            </button>
                            <button
